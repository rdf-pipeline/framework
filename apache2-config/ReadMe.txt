...
Please fix manually. Aborting.
	...
	ports.conf	-- Sets listening port for apache2.
			...
			Lives in /etc/apache2 .
			OBSOLETE?  Not sure this still needs to be changed.
...
3. chown -R dbooth:dbooth /var/www

4. Install and configure Oracle Java6, via Software Center.

5. Install and configure Sesame.
